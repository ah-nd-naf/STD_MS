...
const Dashboard = () => {
  ...
  useEffect(() => {
    const getStudentData = async () => {
      try {
        ...
        // Extracting name from email (e.g., "ahnaf" from "ahnaf@gmail.com")
  ...
  // Stats mapped to your Student Management Roadmap
  const stats = [
    { 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          {stats.map((stat) => {
            ...
            return (
              <div 
                key={stat.label} 
                className="bg-gray-900 border border-gray-800 p-6 rounded-2xl hover:border-gray-700 transition-all duration-300 shadow-sm"
              >
